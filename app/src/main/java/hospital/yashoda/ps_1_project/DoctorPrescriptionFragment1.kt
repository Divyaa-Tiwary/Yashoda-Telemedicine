...
class DoctorPrescriptionFragment1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_doctor_prescription1, container, false)
    }
    ...
    private fun setListeners() {
        Button.setOnClickListener {
            ...
            changeFragment(DoctorPrescriptionFragment2.newInstance(EditText.text.toString().trim()))
        }
    }
