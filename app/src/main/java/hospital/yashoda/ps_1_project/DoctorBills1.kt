...
class DoctorBills1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_doctor_bills1, container, false)
    }
    ...
    private fun setListeners() {
        Button.setOnClickListener {
            ...
            changeFragment(DoctorBills2.newInstance(EditText.text.toString().trim()))
        }
    }
