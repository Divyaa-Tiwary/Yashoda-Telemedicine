...
import kotlinx.android.synthetic.main.fragment_doctor_prescription2.*


class DoctorPrescriptionFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_doctor_prescription2, container, false)
    }
    ...
    private fun uploadFile() {
        ...
        if (Uri.EMPTY != image_url) {
            val mStorageReference = storageReference.child("prescription").child(
    ...
    private fun uploadToDatabase() {
        ...
        firestore.collection("Users").document(id).update("prescription", imageBitmap.toString())
    ...
    companion object {
        ...
        fun newInstance(id: String) = DoctorPrescriptionFragment2().apply {
