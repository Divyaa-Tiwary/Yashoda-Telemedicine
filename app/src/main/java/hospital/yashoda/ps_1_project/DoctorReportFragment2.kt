...
import kotlinx.android.synthetic.main.fragment_doctor_report2.*


class DoctorReportFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_doctor_report2, container, false)
    }
    ...
    private fun uploadFile() {
        ...
        if (Uri.EMPTY != image_url) {
            val mStorageReference = storageReference.child("report").child(
    ...
    private fun uploadToDatabase() {
        ...
        firestore.collection("Users").document(id).update("medicalReport", imageBitmap.toString())
    ...
    companion object {
        ...
        fun newInstance(id: String) = DoctorReportFragment2().apply {
